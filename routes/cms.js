...
module.exports = function(app) {
    ...
    //作品查看
    app.get('/cms/works', isAuthenticated, function (req, res, next) {
        var context = {
            layout:'cms',
            user:req.user,
    ...
    //作品修改
    app.get('/cms/work/edit/:id', isAuthenticated, function (req, res) {
    ...
    //案例增加
    app.get('/cms/work/add', isAuthenticated, function (req, res) {
        var context = {
            layout:'cms',
            user:req.user,
    ...
    app.get('/cms/work/delete/:id', function (req, res) {
